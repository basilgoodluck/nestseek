  ...
  return (
    <div className='pt-16 pb-8'>
        <div className='text-center bg-cover bg-center bg-Subscribe w-11/12 m-auto p-6 rounded-3xl'>
            ...
            <form className='pb-5'>
                <div className='bg-white border-gray-100 border-2 rounded-3xl flex justify-between pl-5 items-center lg:w-2/3 m-auto'>
                    <input className='w-full rounded-3xl outline-none text-base'/>
