  ...
  return (
    <div className='w-screen'>
        <div className='relative'>
            ...
            <Header />
            <div className='flex lg:justify-start lg:items-center lg:flex-row flex-col justify-center items-start pt-3 px-2 lg:pl-16 overflow-x-hidden' style={{minHeight: '80vh', maxHeight: '80vh'}}>
