  ...
  return (
    <div className='lg:h-screen w-screen lg:pb-8'>
        <div className='relative'>
            ...
            <Header />
            <div className='flex m-auto lg:justify-start lg:items-center flex-col lg:flex-row justify-center py-3 px-2 lg:pl-16 overflow-x-hidden' style={{minHeight: '80vh', maxHeight: '100vh'}}>
