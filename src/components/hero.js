...
const Hero = () => {
  ...
  return (
    <div className='h-screen w-screen lg:pb-8'>
        <div className='relative'>
            ...
            <Header />
            <div className='flex m-auto lg:justify-start lg:items-center flex-col lg:flex-row justify-center h-screen py-3 px-2 lg:pl-16 overflow-x-hidden'>
                <div className='item-start py-6 lg:py-0 relative w-full lg:w-2/5'>
