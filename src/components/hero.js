  ...
  return (
    <div className='lg:h-screen w-screen lg:pb-8'>
        <div className='relative'>
            ...
            <Header />
            <div className='h-screen flex m-auto lg:justify-start lg:items-center flex-col lg:flex-row justify-center py-3 px-2 lg:pl-16 overflow-x-hidden'>
                <div className='item-start pt-6 pb-2 lg:py-0 relative w-full lg:w-2/5'>
